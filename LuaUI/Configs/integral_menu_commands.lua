...
local factoryUnitPosDef = {
	...
	frtankfactory = {
		frveharmored          = unitTypes._1x1,
		frtankchamond         = unitTypes._1x2,
		frtankft              = unitTypes._1x3,
		arty2         		  = unitTypes._1x4,
		arty3                 = unitTypes._1x5,
	},
	gertankfactory = {
		gerveharmored         = unitTypes._1x1,
		gertanka7v            = unitTypes._1x2,
		gervehflak         	  = unitTypes._1x3,
		gerartybertha         = unitTypes._1x4,
		gerartyskoda          = unitTypes._1x5,
	},
	brtankfactory = {
		brtankmarkiv          = unitTypes._1x1,
		brveharmored          = unitTypes._1x2,
		brartybl8          	  = unitTypes._1x4,
	},
	frhangar = {
